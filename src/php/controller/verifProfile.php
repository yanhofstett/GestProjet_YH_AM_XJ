                    ...
                    */
                    ...
                    if (true/*$usePseudoTrue == true && $useEmailTrue == true && $usePasswordTrue == true*/)
                    {
                        ...
                        if (!empty(trim($_POST["password"])))
                        {
                            ...
                            Database::getInstance() -> modifyAthlete($_POST["idUser"],trim($_POST["name"]),trim($_POST["surname"]),trim($_POST["email"]),trim($_POST["phone"]),trim($_POST["street"]),trim($_POST["town"]),trim($_POST["NPA"]), password_hash(trim($_POST["password"]), PASSWORD_DEFAULT));
                        ...
                        else
                        {
                            ...
                            Database::getInstance() -> modifyAthlete($_POST["idUser"],trim($_POST["name"]),trim($_POST["surname"]),trim($_POST["email"]),trim($_POST["phone"]),trim($_POST["street"]),trim($_POST["town"]),trim($_POST["NPA"]), password_hash($_SESSION["password"], PASSWORD_DEFAULT));
                        }
                        var_dump($_POST);
                ...
                else
                {
                    ...
                    */
                    ...
                    if (true/*$usePseudoTrue == true && $useEmailTrue == true && $usePasswordTrue == true*/)
                    {
                        ...
                        {
                            //modifie l'utilisateur dans la DB (avec le nouveau mot de passe)
                            Database::getInstance() -> modifyCoach($_POST["idUser"],trim($_POST["name"]),trim($_POST["surname"]),trim($_POST["email"]),trim($_POST["phone"]),trim($_POST["street"]),trim($_POST["town"]),trim($_POST["NPA"]), password_hash(trim($_POST["password"]), PASSWORD_DEFAULT));
                        ...
                        {
                            //modifie l'utilisateur dans la DB (avec son ancien mot de passe)
                            Database::getInstance() -> modifyCoach($_POST["idUser"],trim($_POST["name"]),trim($_POST["surname"]),trim($_POST["email"]),trim($_POST["phone"]),trim($_POST["street"]),trim($_POST["town"]),trim($_POST["NPA"]), password_hash($_SESSION["password"], PASSWORD_DEFAULT));
                        }
                        var_dump($_POST);
                        //redirige ver la page de match
                        header("Location:../../../index.php?page=profile");
