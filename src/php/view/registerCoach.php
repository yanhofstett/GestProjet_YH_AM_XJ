<?php
    ...
    if(isset($_GET['msgCreateUser']))
    {
        ...
        if($_GET['msgCreateUser']=='CUF')
        {
            ...
            <script>
                ...
                {    
                    ...
                    location.href="registerCoach.php";
                }
            // Fin du script
            </script>
		...
		// Sinon si le GET est égal à REAOT
		else if($_GET['msgCreateUser']=='REAOT')
		{
			// Affiche le message d'erreur et que la modification n'a pas pu aboutir depuis le config.php
					...
					<div class="col-md-6 col-lg-4">
						<div class="login-wrap p-0">
							...
							<form action="../controller/verifRegister.php" method="post" class="signin-form" enctype="multipart/form-data">
								<div class="isWhat">
									<a class="selectIntero athleteIntero" href="registerAthlete.php">Athlète?</a>   
									<a class="selectIntero coachIntero activeCoachRegister" href="registerCoach.php">Coach?</a>				
								</div>
								...
								<div class="form-group" id="coachSee">
									<input type="textarea" class="form-control" id="coachSee" placeholder="Votre expérience" name="experience" required>
									<label for="downloadFile" id="coachSee">Image de vous :</label><br>
									<input type="file" class="form-control" style="width: 100%;" name="downloadFile" id="downloadFile" value="choose">
								</div>
								<br>
								<div class="form-group">
								...
								<div class="form-group">
									<button type="submit" name="btnRegisterCoach" class="form-control btn btn-primary submit px-3">s'enregistrer</button>
