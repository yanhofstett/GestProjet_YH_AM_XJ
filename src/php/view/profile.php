        ...
        ?>
            <body class="text-center">
                ...
                <form method="post" action="src/php/controller/verifProfile.php">
                    ...
                    <div><label for="name">Nom: </label><br>
                    <input id="name" type="text" required class="addRecipes" name="name" value="<?php echo $user["coaName"]?>"></div><br>
                    
                    <div><label for="surname">Prénom: </label><br>
                    <input id="surname" type="text" required class="addRecipes" name="surname" value="<?php echo $user["coaSurname"]?>"></div><br>
                    
                    <div><label for="email">Email: </label><br>
                    <input id="email" type="text" required class="addRecipes" name="email" value="<?php echo $user["coaEmail"]?>"></div><br>

                    <div><label for="phone">Numéro de téléphonne: </label><br>
                    <input id="phone" type="text" required class="addRecipes" name="phone" value="<?php echo $user["coaPhone"]?>"></div><br>
                    
                    <div><label for="street">Experience: </label><br>
                    <input id="street" type="text" required class="addRecipes" name="street" value="<?php echo $user["coaExperience"]?>"></div><br>
                    
                    <div><label for="town">Image: </label><br>
                    <input id="town" type="text" required class="addRecipes" name="town" value="<?php echo $user["coaImage"]?>"></div><br>
